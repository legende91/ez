...
$oldSetArray_cc541897c482d0841280f3db274a0d52 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="children" method="post" action="/index.php/content/action">
...
$text .= ' title="Monter d\'un niveau."><img src="/design/admin2/images/up-16x16-grey.png" width="16" height="16" alt="Monter d\'un niveau." title="Monter d\'un niveau." /></a>&nbsp;';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$text .= '" />
    ...
    ';
$oldRestoreIncludeArray_9156ddbb000aed9448bfd331cf6136ef = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/formation/cache/template/compiled/children_detailed-c4d252acbbf0b7d8fc9cfc566f5d8dbd.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/formation/cache/template/compiled/children_detailed-c4d252acbbf0b7d8fc9cfc566f5d8dbd.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_9156ddbb000aed9448bfd331cf6136ef;
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_836178cc5494bd069c94c8206a974357 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/formation/cache/template/compiled/alphabetical-7dd08342a426bf133f5cac00ae85b915.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/formation/cache/template/compiled/alphabetical-7dd08342a426bf133f5cac00ae85b915.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_836178cc5494bd069c94c8206a974357;
...
$setArray = $oldSetArray_cc541897c482d0841280f3db274a0d52;
$tpl->Level--;
?>
