...
$oldSetArray_f4e45d04d6f26d6bfb836c52fcc58ee7 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '    </li>
';
$oldRestoreIncludeArray_ff270dd65d9704cce0a620cdc7b91d7d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/formation/cache/template/compiled/window_controls_extratabs-9b5df374199a30f92979dc3be445bc00.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/formation/cache/template/compiled/window_controls_extratabs-9b5df374199a30f92979dc3be445bc00.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_ff270dd65d9704cce0a620cdc7b91d7d;
...
$text .= '<div class="tabs-content">
    ';
$oldRestoreIncludeArray_8336da217462d0385703a8745e72a789 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
{
$resourceFound = false;
if ( file_exists( 'var/formation/cache/template/compiled/windows_user-0cd3d07b15795f18464bf63582370466.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/formation/cache/template/compiled/windows_user-0cd3d07b15795f18464bf63582370466.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/formation/cache/template/compiled/windows-aaf0f31e9a24ef77f543975f90234907.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/formation/cache/template/compiled/windows-aaf0f31e9a24ef77f543975f90234907.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_8336da217462d0385703a8745e72a789;
...
$setArray = $oldSetArray_f4e45d04d6f26d6bfb836c52fcc58ee7;
$tpl->Level--;
?>
