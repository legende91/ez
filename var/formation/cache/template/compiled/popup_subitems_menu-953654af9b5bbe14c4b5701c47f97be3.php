...
$oldSetArray_35a8dbe4f1d80a33fee422e2fb06dcad = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-view\'] = { \'url\': "/index.php/content/view/full/%nodeID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-preview\'] = { \'url\': "/index.php/content/versionview/%objectID%/%version%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-edit\'] = { \'url\': "/index.php/content/edit/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy\'] = { \'url\': "/index.php/content/copy/%objectID%" };
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-copy-subtree\'] = { \'url\': "/index.php/content/copysubtree/%nodeID%" };
...
$setArray = $oldSetArray_35a8dbe4f1d80a33fee422e2fb06dcad;
$tpl->Level--;
?>
