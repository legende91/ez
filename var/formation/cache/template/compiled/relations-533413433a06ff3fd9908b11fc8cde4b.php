...
$oldSetArray_ecdf3f51232d197ea56c99a2eace1553 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $fe_array_8ef0bd49181921a6cf6168619ad677e3_11 );
$fe_array_8ef0bd49181921a6cf6168619ad677e3_11 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'related_objects_grouped', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['related_objects_grouped'] : null;
...
$vars[$rootNamespace]['related_objects_array'] = $fe_val_8ef0bd49181921a6cf6168619ad677e3_11;
$vars[$rootNamespace]['attribute_id'] = $fe_key_8ef0bd49181921a6cf6168619ad677e3_11;
$text .= '        ';
// if begins
unset( $if_cond );
unset( $if_cond1 );
...
unset( $fe_array_8ef0bd49181921a6cf6168619ad677e3_10 );
$fe_array_8ef0bd49181921a6cf6168619ad677e3_10 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'related_objects_array', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['related_objects_array'] : null;
...
$vars[$rootNamespace]['object'] = $fe_val_8ef0bd49181921a6cf6168619ad677e3_10;
$text .= '            <tr class="';
unset( $var );
unset( $var );
...
$resourceFound = false;
if ( file_exists( 'var/formation/cache/template/compiled/text_linked-0bdb8aeca1686d1270e181a71ef79af0.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/formation/cache/template/compiled/text_linked-0bdb8aeca1686d1270e181a71ef79af0.php' );
...
$text .= '</td>
            <td>
                ';
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 );
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_id'] : null;
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071->templateValue();
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071->templateValue();
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107 = ( ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 ) == ( 0 ) );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1071 );
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107->templateValue();
...
elseif ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_107 )
{
$text .= '                    ';
...
unset( $fe_array_8ef0bd49181921a6cf6168619ad677e3_9 );
$fe_array_8ef0bd49181921a6cf6168619ad677e3_9 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'related_objects_id_typed', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['related_objects_id_typed'] : null;
...
$vars[$rootNamespace]['relation_id_array'] = $fe_val_8ef0bd49181921a6cf6168619ad677e3_9;
$vars[$rootNamespace]['relation_type'] = $fe_key_8ef0bd49181921a6cf6168619ad677e3_9;
$text .= '                        ';
// if begins
unset( $if_cond );
unset( $if_cond1 );
...
unset( $fe_array_8ef0bd49181921a6cf6168619ad677e3_14 );
$fe_array_8ef0bd49181921a6cf6168619ad677e3_14 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'reverse_related_objects_grouped', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['reverse_related_objects_grouped'] : null;
...
$text .= '</td>
            <td>
                ';
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 );
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_id'] : null;
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151->templateValue();
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151->templateValue();
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115 = ( ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 ) == ( 0 ) );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1151 );
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115->templateValue();
...
elseif ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_115 )
{
$text .= '                    ';
// def $relation_name_array
if ( $tpl->hasVariable( 'relation_name_array', $rootNamespace ) )
...
unset( $fe_array_8ef0bd49181921a6cf6168619ad677e3_12 );
$fe_array_8ef0bd49181921a6cf6168619ad677e3_12 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'reverse_related_objects_id_typed', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['reverse_related_objects_id_typed'] : null;
...
$text .= '</table>';
$oldRestoreIncludeArray_44e71e379fa58077d328cdfd60ea5818 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_44e71e379fa58077d328cdfd60ea5818;


$setArray = $oldSetArray_ecdf3f51232d197ea56c99a2eace1553;
$tpl->Level--;
?>
