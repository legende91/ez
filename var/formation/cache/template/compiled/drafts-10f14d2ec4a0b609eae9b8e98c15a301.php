...
$oldSetArray_46f59f3f67bab6a6c82b29dee7630abe = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
                    <img src="/design/standard/images/edit.gif" width="16" height="16" border="0" alt="Modifier" />
                </a>
            </td>
        </tr>
    ';
...
$setArray = $oldSetArray_46f59f3f67bab6a6c82b29dee7630abe;
$tpl->Level--;
?>
