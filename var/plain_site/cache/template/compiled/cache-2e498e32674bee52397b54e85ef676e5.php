...
// Filename:  design/admin2/templates/setup/cache.tpl
// Timestamp: 1342179298 (Fri Jul 13 13:34:58 CEST 2012)
$oldSetArray_d2ced1bba94fb2d496a0b13654ec6609 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="clearcacheform" method="post" action="/index.php/setup/cache">
...
<tr>
    <th class="tight"><img src="/design/admin2/images/toggle-button-16x16.gif" width="16" height="16" alt="Inverser la sélection." onclick="ezjs_toggleCheckboxes( document.clearcacheform, \'CacheList[]\' ); return false;" title="Inverser la sélection." /></th>
    <th>Nom</th>
    <th>Chemin</th>
</tr>';
unset( $loopItem );
...
$setArray = $oldSetArray_d2ced1bba94fb2d496a0b13654ec6609;
$tpl->Level--;
?>
