...
$oldSetArray_b2a680fa073e07a3f8780b9aba33c4e0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '    <a href="/index.php/content/dashboard" title="eZ Publish ';
unset( $var );
$var = call_user_func_array( array( new eZSetupFunctionCollection(), 'fetchFullVersionString' ),
  array(  ) );
$var = isset( $var['result'] ) ? $var['result'] : null;
...
$oldRestoreIncludeArray_b1aeee37cc1779aa713b29e7f3700344 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/page_search-740b72e51df8b7302501c1ed39d21bd6.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/page_search-740b72e51df8b7302501c1ed39d21bd6.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_b1aeee37cc1779aa713b29e7f3700344;
...
{
$text .= '    <a href="/index.php/user/logout" title="Quitter." id="header-usermenu-logout">Fermeture de session</a>';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_b2a680fa073e07a3f8780b9aba33c4e0;
$tpl->Level--;
?>
