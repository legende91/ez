...
$oldSetArray_35039c7fedcb9481fcec5aba7ebfe461 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'ContextMenu\'][\'elements\'][\'menu-view\'] = { \'url\': "/index.php/content/view/full/%nodeID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-edit\'] = { \'url\': "/index.php/content/edit/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy\'] = { \'url\': "/index.php/content/copy/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy-subtree\']= { \'url\': "/index.php/content/copysubtree/%nodeID%" };
...
$setArray = $oldSetArray_35039c7fedcb9481fcec5aba7ebfe461;
$tpl->Level--;
?>
