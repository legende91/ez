...
$oldSetArray_a35a26b339cdf14a155888be2a981e43 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $fe_array_dbebccfb075865fcd879702972f4abaa_17 );
$fe_array_dbebccfb075865fcd879702972f4abaa_17 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'locales', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['locales'] : null;
...
$vars[$rootNamespace]['language'] = $fe_val_dbebccfb075865fcd879702972f4abaa_17;
if ( $skipDelimiter )
    $skipDelimiter = false;
else
{ // delimiter begins
...
unset( $fe_array_dbebccfb075865fcd879702972f4abaa_18 );
$fe_array_dbebccfb075865fcd879702972f4abaa_18 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'locales', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['locales'] : null;
...
$vars[$rootNamespace]['locale'] = $fe_val_dbebccfb075865fcd879702972f4abaa_18;
if ( $skipDelimiter )
    $skipDelimiter = false;
else
{ // delimiter begins
...
unset( $fe_array_dbebccfb075865fcd879702972f4abaa_19 );
$fe_array_dbebccfb075865fcd879702972f4abaa_19 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'visible_columns', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['visible_columns'] : null;
...
$vars[$rootNamespace]['object'] = $fe_val_dbebccfb075865fcd879702972f4abaa_19;
$vars[$rootNamespace]['index'] = $fe_key_dbebccfb075865fcd879702972f4abaa_19;
if ( $skipDelimiter )
    $skipDelimiter = false;
else
{ // delimiter begins
...
{
$text .= '    ';
unset( $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 );
unset( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 );
unset( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 );
$elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'node', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['node'] : null;
$elseif_cond_dbebccfb075865fcd879702972f4abaa_1312 = compiledFetchAttribute( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311, 'path_array' );
unset( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 );
$elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 = $elseif_cond_dbebccfb075865fcd879702972f4abaa_1312;
if (! isset( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 ) ) $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 = NULL;
while ( is_object( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 ) and method_exists( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311, 'templateValue' ) )
    $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 = $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311->templateValue();
while ( is_object( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 ) and method_exists( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311, 'templateValue' ) )
    $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 = $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311->templateValue();
if( is_string( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 ) )
{
  $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 = ( strpos( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311, "5" ) !== false );
}
else if ( is_array( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 ) )
{
  $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 = in_array( "5", $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 );
}
else
{
$elseif_cond_dbebccfb075865fcd879702972f4abaa_131 = false;
}unset( $elseif_cond_dbebccfb075865fcd879702972f4abaa_1311 );
if (! isset( $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 ) ) $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 = NULL;
while ( is_object( $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 ) and method_exists( $elseif_cond_dbebccfb075865fcd879702972f4abaa_131, 'templateValue' ) )
    $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 = $elseif_cond_dbebccfb075865fcd879702972f4abaa_131->templateValue();
...
elseif ( $elseif_cond_dbebccfb075865fcd879702972f4abaa_131 )
{
$text .= '        ';
// def $group_id
if ( $tpl->hasVariable( 'group_id', $rootNamespace ) )
...
unset( $fe_array_dbebccfb075865fcd879702972f4abaa_20 );
$fe_array_dbebccfb075865fcd879702972f4abaa_20 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'can_create_classes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['can_create_classes'] : null;
...
$vars[$rootNamespace]['group'] = $fe_val_dbebccfb075865fcd879702972f4abaa_20;
if ( $skipDelimiter )
    $skipDelimiter = false;
else
{ // delimiter begins
...
unset( $fe_array_dbebccfb075865fcd879702972f4abaa_22 );
$fe_array_dbebccfb075865fcd879702972f4abaa_22 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'can_create_classes', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['can_create_classes'] : null;
...
$vars[$rootNamespace]['group'] = $fe_val_dbebccfb075865fcd879702972f4abaa_22;
if ( $skipDelimiter )
    $skipDelimiter = false;
else
{ // delimiter begins
...
unset( $fe_array_dbebccfb075865fcd879702972f4abaa_21 );
$fe_array_dbebccfb075865fcd879702972f4abaa_21 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'group', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['group'] : null;
$fe_array_dbebccfb075865fcd879702972f4abaa_211 = compiledFetchAttribute( $fe_array_dbebccfb075865fcd879702972f4abaa_21, 'items' );
unset( $fe_array_dbebccfb075865fcd879702972f4abaa_21 );
$fe_array_dbebccfb075865fcd879702972f4abaa_21 = $fe_array_dbebccfb075865fcd879702972f4abaa_211;
...
$vars[$rootNamespace]['can_create_class'] = $fe_val_dbebccfb075865fcd879702972f4abaa_21;
if ( $skipDelimiter )
    $skipDelimiter = false;
else
{ // delimiter begins
...
$setArray = $oldSetArray_a35a26b339cdf14a155888be2a981e43;
$tpl->Level--;
?>
