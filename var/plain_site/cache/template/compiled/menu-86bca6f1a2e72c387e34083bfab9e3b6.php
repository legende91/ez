...
$oldSetArray_d9473a3623beb21b3833c27f7915f16f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div id="contentstructure">
    ';
$oldRestoreIncludeArray_7d0e12fe382bd4352eb46a4988dc123b = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_7d0e12fe382bd4352eb46a4988dc123b;
...
$text .= ' title="Voir et gérer le contenu de la corbeille."><img src="/design/admin2/images/trash-icon-16x16.gif" width="16" height="16" alt="Corbeille" />&nbsp;<span>Corbeille</span></a>
</div>';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_d9473a3623beb21b3833c27f7915f16f;
$tpl->Level--;
?>
