<?php
// URI:       design/admin2/templates/class/groups.tpl
// Filename:  design/admin2/templates/class/groups.tpl
// Timestamp: 1342179294 (Fri Jul 13 13:34:54 CEST 2012)
$oldSetArray_93954e30c2f32e2eaeb33d6c53356ebe = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var2 );
$var2 = $var3;
$var3 = compiledFetchAttribute( $var2, 'view' );
unset( $var2 );
$var2 = $var3;
...
$var4 = compiledFetchAttribute( $var3, 'ingroup_list' );
unset( $var3 );
$var3 = $var4;
...
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
$var2 = array( '%group_count' => $var3 );unset( $var3 );
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
    $var2 = $var2->templateValue();
$var3 = array();
...
$var = strtr( 'Membre de groupes de classes (%group_count)', $var3 );
...
<tr>
    <th class="tight">&nbsp;</th>
    <th class="wide">Groupe de classes</th>
</tr>';
unset( $loopItem );
unset( $loopItem );
$loopItem = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'class', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['class'] : null;
$loopItem1 = compiledFetchAttribute( $loopItem, 'ingroup_list' );
unset( $loopItem );
$loopItem = $loopItem1;
...
$vars[$currentNamespace]['Groups'] = $variableValue;
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Groups', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Groups'] : null;
...
$text .= '">
    <td class="tight"><input type="checkbox" name="group_id_checked[]" value="';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Groups', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Groups'] : null;
...
unset( $var );
$var = $var1;
$var1 = compiledFetchAttribute( $var, 'group_id' );
unset( $var );
$var = $var1;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
...
$text .= '" title="Sélectionner le groupe de classes à supprimer." /></td>
    <td class="wide">';
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Groups', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Groups'] : null;
...
unset( $var3 );
unset( $var3 );
$var3 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Groups', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Groups'] : null;
$var4 = compiledFetchAttribute( $var3, 'item' );
unset( $var3 );
$var3 = $var4;
$var4 = compiledFetchAttribute( $var3, 'group_id' );
unset( $var3 );
$var3 = $var4;
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'Groups', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['Groups'] : null;
$var2 = compiledFetchAttribute( $var1, 'item' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'group_name' );
unset( $var1 );
$var1 = $var2;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
<div class="box-bc">
    ...
    <input class="button" type="submit" name="RemoveGroupButton" value="Supprimer de la sélection" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Supprimer la classe <%class_name> des groupes de classes sélectionnés.', $var4 );
  ...
  array (
    ...
    array (
      ...
      2 => false,
                       ...
                       $rootNamespace, $currentNamespace, $show2Data, false, false );
$show2 = $show2Data['value'];
unset( $show2Data );
if (! isset( $show2 ) ) $show2 = NULL;
while ( is_object( $show2 ) and method_exists( $show2, 'templateValue' ) )
    $show2 = $show2->templateValue();
...
$text .= '        <select name="ContentClass_group" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Sélectionnez le groupe où la classe <%class_name> devra être ajoutée.', $var4 );
unset( $var3, $var4, $var5, $var6 );
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
...
unset( $loopItem );
$loopItem = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'class', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['class'] : null;
$loopItem1 = compiledFetchAttribute( $loopItem, 'group_list' );
unset( $loopItem );
$loopItem = $loopItem1;
if (! isset( $loopItem ) ) $loopItem = NULL;
while ( is_object( $loopItem ) and method_exists( $loopItem, 'templateValue' ) )
...
$currentNamespace .= ( $currentNamespace ? ":" : "" ) . 'AllGroup';
...
$if_cond3 = compiledFetchAttribute( $if_cond2, 'ingroup_id_list' );
unset( $if_cond2 );
$if_cond2 = $if_cond3;
...
if ( $namespace == '' )
    ...
    $namespace .= ':AllGroup';
unset( $if_cond3 );
$if_cond3 = ( array_key_exists( $namespace, $vars ) and array_key_exists( 'item', $vars[$namespace] ) ) ? $vars[$namespace]['item'] : null;
...
$text .= '        </select>
        <input class="button" type="submit" name="AddGroupButton" value="Ajouter au groupe de classes" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Ajouter la classe <%class_name> au groupe spécifié dans le menu à gauche.', $var4 );
unset( $var3, $var4, $var5, $var6 );
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
...
$text .= '        <select name="ContentClass_group" disabled="disabled" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
unset( $var4 );
$var4 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'class_name', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['class_name'] : null;
if (! isset( $var4 ) ) $var4 = NULL;
while ( is_object( $var4 ) and method_exists( $var4, 'templateValue' ) )
    $var4 = $var4->templateValue();
$var3 = array( '%class_name' => $var4 );unset( $var4 );
...
$var1 = strtr( 'La classe <%class_name> existe déjà dans tous les groupes de classes.', $var4 );
unset( $var3, $var4, $var5, $var6 );
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
...
$text .= '">
        <option value="-1">Pas de groupe</option>
        </select>
        <input class="button-disabled" type="submit" name="AddGroupButton" value="Ajouter au groupe de classes" disabled="disabled" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_93954e30c2f32e2eaeb33d6c53356ebe;
$tpl->Level--;
?>
