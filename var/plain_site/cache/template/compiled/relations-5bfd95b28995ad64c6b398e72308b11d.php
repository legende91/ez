...
$oldSetArray_0466997b6ff45c9d74d41c8041599a42 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '</td>
            <td>
                ';
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 );
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_id'] : null;
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041->templateValue();
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041->templateValue();
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104 = ( ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 ) == ( 0 ) );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1041 );
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104->templateValue();
...
elseif ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_104 )
{
$text .= '                    ';
...
$text .= '</td>
            <td>
                ';
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 );
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'attribute_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['attribute_id'] : null;
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121->templateValue();
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121->templateValue();
$elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112 = ( ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 ) == ( 0 ) );
unset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_1121 );
if (! isset( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112 ) ) $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112 = NULL;
while ( is_object( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112 ) and method_exists( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112, 'templateValue' ) )
    $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112 = $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112->templateValue();
...
elseif ( $elseif_cond_8ef0bd49181921a6cf6168619ad677e3_112 )
{
$text .= '                    ';
// def $relation_name_array
if ( $tpl->hasVariable( 'relation_name_array', $rootNamespace ) )
...
$text .= '</table>';
$oldRestoreIncludeArray_43758e7773f2d7f04320d2693652066a = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_43758e7773f2d7f04320d2693652066a;


$setArray = $oldSetArray_0466997b6ff45c9d74d41c8041599a42;
$tpl->Level--;
?>
