...
$oldSetArray_8db20aa13dc59a692ea2a6a9039e5e06 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
';
$oldRestoreIncludeArray_18959574e57732f74d645df005b93f5e = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_context_menu-c7249026be64400cfd2368f06ef48f02.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_context_menu-c7249026be64400cfd2368f06ef48f02.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_18959574e57732f74d645df005b93f5e;
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_subitems_menu-46bf975cd85f068d26fdd5bbc07efe61.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_subitems_menu-46bf975cd85f068d26fdd5bbc07efe61.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_class_menu-b9393522d8a190786c62013f254b2f00.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_class_menu-b9393522d8a190786c62013f254b2f00.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_bookmark_menu-d076143e15fdbe743de267a0b26372e3.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_bookmark_menu-d076143e15fdbe743de267a0b26372e3.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$oldRestoreIncludeArray_735f85bceafd833ebbe932d4385d2450 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_sub_createhere_menu-ef97d989bd2143e9eff159955cc9793a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_sub_createhere_menu-ef97d989bd2143e9eff159955cc9793a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_735f85bceafd833ebbe932d4385d2450;
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_sub_edit_menu-6020a76d5c80391445bcb047f6b5a491.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_sub_edit_menu-6020a76d5c80391445bcb047f6b5a491.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_sub_advance_menu-6a2e52b831446c99634915945da05522.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_sub_advance_menu-6a2e52b831446c99634915945da05522.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_sub_editclass_menu-cba4dbbf1d090d2a90507dd3e9f2ca94.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_sub_editclass_menu-cba4dbbf1d090d2a90507dd3e9f2ca94.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/popup_sub_siteaccess_menus-7d8d81704296bcc2ad26812b993a3178.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/popup_sub_siteaccess_menus-7d8d81704296bcc2ad26812b993a3178.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
<form id="menu-form-addbookmark" method="post" action="/index.php/content/action">
  <input type="hidden" name="ContentNodeID" value="%nodeID%" />
  <input type="hidden" name="ActionAddToBookmarks" value="x" />
</form>


<form id="menu-form-remove" method="post" action="/index.php/content/action">
...
<form id="menu-form-move" method="post" action="/index.php/content/action">
  <input type="hidden" name="TopLevelNode" value="%nodeID%" />
  <input type="hidden" name="ContentNodeID" value="%nodeID%" />
  <input type="hidden" name="ContentObjectID" value="%objectID%" />
...
<form id="menu-form-notify" method="post" action="/index.php/content/action">
  <input type="hidden" name="ContentNodeID" value="%nodeID%" />
  <input type="hidden" name="ActionAddToNotification" value="x" />
</form>
';

$setArray = $oldSetArray_8db20aa13dc59a692ea2a6a9039e5e06;
$tpl->Level--;
?>
