...
$oldSetArray_21c92eedcbafdb467558dc419bb03995 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <div class="button-left"><a id="maincontent-show" class="show-hide-tabs" href="/index.php/user/preferences/set/admin_navigation_content/1" title="Activer les &quot;onglets&quot; par défaut lorsque vous parcourez le contenu.">+</a></div>';
}
else
{
$text .= '    <div class="button-left"><a id="maincontent-hide" class="show-hide-tabs" href="/index.php/user/preferences/set/admin_navigation_content/0" title="Désactiver les &quot;onglets&quot; par défaut lorsque vous parcourez le contenu.">-</a></div>';
}
unset( $if_cond );
// if ends
...
$text .= '    </li>
';
$oldRestoreIncludeArray_419cdef080d21ceff61ad7a6a9555e4d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/window_controls_extratabs-d140bb1aecfe00414192e899017f1d5c.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/window_controls_extratabs-d140bb1aecfe00414192e899017f1d5c.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_419cdef080d21ceff61ad7a6a9555e4d;
...
$text .= '<div class="tabs-content">
    ';
$oldRestoreIncludeArray_b5dae202b574efcbbda5e6243299c6d7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/windows_user-30024645990515d111d94e825ffa984b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'design/admin/override/templates/windows_user.tpl' );
include( '' . 'var/plain_site/cache/template/compiled/windows_user-30024645990515d111d94e825ffa984b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'design/admin/override/templates/windows_user.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/windows-f9cffa2419114c9a05f34f86483c22a4.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/windows-f9cffa2419114c9a05f34f86483c22a4.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_b5dae202b574efcbbda5e6243299c6d7;
...
$setArray = $oldSetArray_21c92eedcbafdb467558dc419bb03995;
$tpl->Level--;
?>
