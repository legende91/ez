...
$oldSetArray_2cf840be233906ae495413fa6cc9f370 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/index.php/content/translation">
...
<tr>
    <th class="tight"><img src="/design/admin2/images/toggle-button-16x16.gif" width="16" height="16" alt="Inverser la sélection." title="Inverser la sélection." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Langue</th>
...
$text .= '><img src="/design/standard/images/edit.gif" width="16" height="16" alt="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$setArray = $oldSetArray_2cf840be233906ae495413fa6cc9f370;
$tpl->Level--;
?>
