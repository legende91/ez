...
$oldSetArray_aa3269c643b7d93be4e54c0b7d33ac3d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
';
$oldRestoreIncludeArray_7564c1daa0c3fcb23169f25b912c91bd = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/infocollection_validation-1c04b7905fc403ac441dfdbb29276bfa.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/plain_site/cache/template/compiled/infocollection_validation-1c04b7905fc403ac441dfdbb29276bfa.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_7564c1daa0c3fcb23169f25b912c91bd;
...
';
$oldRestoreIncludeArray_5129ce2eb28790b88111f7b48de6df03 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/window_controls_user-71cf209f79fa6cf73e9e07ddb6a28707.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'design/admin/override/templates/window_controls_user.tpl' );
include( '' . 'var/plain_site/cache/template/compiled/window_controls_user-71cf209f79fa6cf73e9e07ddb6a28707.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'design/admin/override/templates/window_controls_user.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/window_controls-283a2f2a9ddcbcb6799bd625829cdf39.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/window_controls-283a2f2a9ddcbcb6799bd625829cdf39.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_5129ce2eb28790b88111f7b48de6df03;
...
{
$text .= '    ';
$oldRestoreIncludeArray_0ac792c48efcd0f50bf4bbb5fce49a98 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/children-d33eb7e839e0f8993be4a5ca159b19a8.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/children-d33eb7e839e0f8993be4a5ca159b19a8.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0ac792c48efcd0f50bf4bbb5fce49a98;
...
$resourceFound = false;
if ( file_exists( 'var/plain_site/cache/template/compiled/no_children-067a7c92be167e128017d1053483779e.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/plain_site/cache/template/compiled/no_children-067a7c92be167e128017d1053483779e.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$setArray = $oldSetArray_aa3269c643b7d93be4e54c0b7d33ac3d;
$tpl->Level--;
?>
