...
$oldSetArray_d879143506c7fb44ce65b32e161156ae = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
{
$text .= '            <p class="advanced hide"><a href="/index.php/content/advancedsearch" title="Recherche avancée.">Avancé</a></p>
        ';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_d879143506c7fb44ce65b32e161156ae;
$tpl->Level--;
?>
